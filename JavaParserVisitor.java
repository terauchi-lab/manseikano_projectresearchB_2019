...
public interface JavaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code flLiteral}
	 * labeled alternative in {@link JavaParser#literal}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFlLiteral(JavaParser.FlLiteralContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStrLiteral(JavaParser.StrLiteralContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBoolLiteral(JavaParser.BoolLiteralContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPrimaryParen(JavaParser.PrimaryParenContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPrimaryThis(JavaParser.PrimaryThisContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPrimarySuper(JavaParser.PrimarySuperContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPrimaryLiteral(JavaParser.PrimaryLiteralContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPrimaryIdentifier(JavaParser.PrimaryIdentifierContext ctx);
	/**
	 * Visit a parse tree produced by the {@code primaryClass}
	 * labeled alternative in {@link JavaParser#primary}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimaryClass(JavaParser.PrimaryClassContext ctx);
	/**
	 * Visit a parse tree produced by the {@code primaryWild}
	 * labeled alternative in {@link JavaParser#primary}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimaryWild(JavaParser.PrimaryWildContext ctx);
	/**
